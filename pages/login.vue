  ...
  methods: {
    login(){
      ...
      if(this.isFormValid){
        ...
        .catch(() => this.$toasted.error('Wrong Username or Password', {duration: 3000, position: "top-center", }))
        // .catch(() => this.$toasted.error('Wrong Username or Password', {duration: 3000}))
      }
